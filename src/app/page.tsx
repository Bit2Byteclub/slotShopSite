        ...
        <div className="w-1/2 flex flex-col justify-between bg-transparent">
          <div>
            <div className="w-38 h-6 bg-[#B8E5DF] mb-4 rounded-xl">
              <p className="text-sm text-center text-[#0F172B] ">★ Trusted Since ____</p>
            </div>
            <h1 className="text-3xl font-semibold mb-1/2">Vegas-Quality Slots.</h1>
            <h1 className="text-3xl font-semibold mb-6 text-[#B8E5DF]">Bargain Prices</h1>
            <p className="text-black">
              Turn your venue into a jackpot destination with premium used slot machines 
              that pack the thrill of Vegas at prices that make sense for your business. 
              Each machine is casino-tested, certified, and ready to generate revenue 
              from day one.
            </p>
          </div>
          ...
          {/*Having an issue here, I don't know how to get the icons so for now blank
             Feel free to fix it if you can get the icons to work, figma is just a drawing
             so I couldn't just copy paste it in*/}
          <div className="mt-6 text-[#45556C] flex items-center gap-2">
            <div className="w-7 h-7 bg-[#B8E5DF] rounded-lg"></div>
            <p className="text-sm">Maintenance Services</p>
            <div className="w-7 h-7 bg-[#FEAA95] rounded-lg"></div>
            <p className="text-sm">Nationwide Shipping</p>
            <div className="w-7 h-7 bg-[#DEEEED] rounded-lg"></div>
